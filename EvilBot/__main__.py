...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`Hello` [😍](https://telegra.ph/file/389b7cbae62494e9578bc.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *𝙴𝚟𝚒𝚕 𝚁𝚘𝚋𝚘𝚝*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/Marin_Kitagawa_xbot?startgroup=true"),
    ],
     [
     ...
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/Marin_Support"),
        InlineKeyboardButton(text="Nothing Ignore This Please", url="httpsuu://github.com/svan42/EvilBot"),
    ], 
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 😍 *Marin Kitagawa* [😘](https://telegra.ph/file/389b7cbae62494e9578bc.jpg)
